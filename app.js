...
var apiMyUploadImage = require('./routes/api/my/uploadImage');
var apiPollsId = require('./routes/api/polls/id');
...
app.use('/api/my/uploadimage', apiMyUploadImage);
app.use('/api/polls/id', apiPollsId);
